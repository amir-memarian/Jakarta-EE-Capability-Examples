...
| `jakarta-servlet-example` | Servlet API | Basic servlet handling, request/response lifecycle, and annotation-based configuration. |

| `jakarta-jsp-example` | Jakarta Server Pages (JSP) | Dynamic HTML rendering with JSP tags, EL expressions, and custom tags. |

| `jakarta-jpa-hibernate` | Jakarta Persistence (JPA) | Object-relational mapping, entity management, JPQL queries, and transaction handling. |
...
&nbsp;  git clone https://github.com/yourusername/jakarta-capability-examples.git

&nbsp;  cd jakarta-capability-examples
